...
namespace AxisCameraMPPlugin.Mvvm
{
	...
	/// </summary>
	/// <typeparam name="TPropertySource">
	/// The type of object to monitor for property changes.
	/// </typeparam>
			...
			where TPropertySource : INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Initializes a new instance of PropertyObserver, which observes the 'propertySource' object
		...
		/// <returns>
		/// The object on which this method was invoked, to allow for multiple invocations chained
		/// together.
		/// </returns>
